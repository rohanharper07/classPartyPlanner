...
# using literal strings to avoid calling print lots for multi line text
print("""This program collects personal information (names and allergies)
      Do not share the backup files with unauthorized people""")
